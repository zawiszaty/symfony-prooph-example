...
```
#### Symfony Di
The code that is directly dependent on prooh is excluded from the di container (prooph has its own solution and you may have "strange" problems if you do not).
```yaml
